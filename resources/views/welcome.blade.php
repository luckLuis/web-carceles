...
<head>
  ...
  <title>Proyecto final -> Grupo3</title>
...
<body>
  ...
  <section id="hero" class="hero">
    <div class="container text-center">
      <div class="col-md-12">
        <h1>
          SISTEMA PENITENCIARIO DEL ECUADOR
        </h1>

        <p class="tagline">
          Unicamente tendrán acceso al sistema si poseen una cuenta autenticada.
        </p>
          ...
          <div class="col-lg-6 col-xs-12 text-lg-right text-right">
            <ul class="list-inline">
              <li class="list-inline-item">
                <a href="https://wa.me/593992310253?text=+Un+cordial+saludo%2C+quisiera+que+me+ayude+con+información...">Contact us</a>
              </li>
            </ul>
          </div>
        </div>
